Para a gestão das torres e das chaves existem duas classes, \textit{Towers.cpp} e \textit{Keys.cpp} respectivamente.
...
\subsection{Ângulo de orientação das Torres}
